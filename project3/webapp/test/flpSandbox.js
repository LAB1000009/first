		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#namespaceproject3-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"namespaceproject3-display": {
								"semanticObject": "namespaceproject3",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=namespace.project3",
									"url": sap.ui.require.toUrl("namespace/project3")
								}
							}
						}
					}
