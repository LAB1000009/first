		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#projectmdprojectmd-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"projectmdprojectmd-display": {
								"semanticObject": "projectmdprojectmd",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=projectmd.projectmd",
									"url": sap.ui.require.toUrl("projectmd/projectmd")
								}
							}
						}
					}
