sap.ui.define([
    ...
    return BaseController.extend("projectmd.projectmd.controller.List", {
        ...
        onPressRefresh:function(){
            this.getView().byId("list").rebindTable();
        },
        ...
        onSearch: function (oEvent) {
            ...
            if (sQuery) {
                this._oListFilterState.aSearch = [new Filter("Product", FilterOperator.Contains, sQuery)];
            } else {
        ...
        onOpenViewSettings: function (oEvent) {
            ...
            if (!this.byId("viewSettingsDialog")) {
                Fragment.load({
                    ...
                    name: "projectmd.projectmd.view.ViewSettingsDialog",
                    controller: this
